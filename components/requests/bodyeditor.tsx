...
const BodyEditor: React.FC<BodyEditorProps> = ({
  ...
  const { openedWorkspace, allopendRequest, openedRequest } = useWorkspace();
  ...
  const handleReset = () => {
    form.setValue("body", "");
    onSubmit({ contentType: "application/json", body: "" });
  };
          ...
          <div className="bg-zinc-900 border-t border-zinc-700 px-4 py-3 flex items-center justify-between">
            ...
            <Button
              ...
              onClick={() => {
                ...
                toast.success("Body Data changed", {
                  duration: 3000,
                  description: "Body data saved successfully",
                });
              }}
            >
              Update Body
